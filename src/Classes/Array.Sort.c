// args: cl.exe /O2 /favor:AMD64 /LD Array.Sort.c ole32.lib oleaut32.lib
	...
	ComparatorFunc comp)
{
	...
	QuickSort(pDisp, lpVtbl, dispidGet, dispidSet, 0, dwLen - 1, comp);
    return 0;
}
    ...
    ComparatorFunc comp)
{
    ...
    int pivot = Partition(pDisp, lpVtbl, dispidGet, dispidSet, low, high, comp);
    QuickSort(pDisp, lpVtbl, dispidGet, dispidSet, low, pivot - 1, comp);
    QuickSort(pDisp, lpVtbl, dispidGet, dispidSet, pivot + 1, high, comp);
}
